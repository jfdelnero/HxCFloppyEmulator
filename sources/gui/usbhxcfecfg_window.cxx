...
usbhxcfecfg_window::usbhxcfecfg_window() {
  { window = new Fl_Double_Window(565, 230, "USB HxC Floppy Emulator settings and status");
    window->user_data((void*)(this));
    { Fl_Group* o = new Fl_Group(4, 7, 411, 63, "USB HxC Floppy Emulator status");
    ...
    { Fl_Group* o = new Fl_Group(420, 7, 140, 114, "Drive ID setting");
      o->box(FL_ENGRAVED_FRAME);
      o->labeltype(FL_ENGRAVED_LABEL);
      o->labelsize(12);
      o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
      { rbt_ds2 = new Fl_Round_Button(425, 55, 100, 16, "DS2");
        rbt_ds2->type(102);
      ...
      { rbt_ds3 = new Fl_Round_Button(425, 70, 100, 16, "MTRON");
        rbt_ds3->type(102);
      ...
      { chk_twistedcable = new Fl_Check_Button(425, 85, 100, 16, "Twisted cable");
      ...
      { chk_disabledrive = new Fl_Check_Button(425, 100, 100, 16, "Disable drive");
      ...
      { rbt_ds0 = new Fl_Round_Button(425, 25, 100, 16, "DS0");
        rbt_ds0->type(102);
      ...
      { rbt_ds1 = new Fl_Round_Button(425, 40, 100, 16, "DS1");
        rbt_ds1->type(102);
    ...
    { Fl_Group* o = new Fl_Group(420, 118, 140, 79, "Mode");
      o->box(FL_ENGRAVED_FRAME);
      o->labeltype(FL_ENGRAVED_LABEL);
      o->labelsize(12);
      o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
      { chk_autoifmode = new Fl_Check_Button(425, 162, 100, 16, "Auto");
      ...
      { chk_doublestep = new Fl_Check_Button(425, 178, 100, 16, "Double Step");
    ...
    { Fl_Button* o = new Fl_Button(420, 200, 140, 25, "OK");
