...
rawfile_loader_window::rawfile_loader_window() {
  { window = new Fl_Double_Window(455, 350, "RAW File format configuration");
    ...
    { chk_side0track_first = new Fl_Check_Button(333, 7, 119, 44, "Tracks of a side grouped in the file");
    ...
    { chk_autogap3 = new Fl_Check_Button(130, 212, 85, 25, "Auto GAP3");
