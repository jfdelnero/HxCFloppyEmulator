...
batch_converter_window::batch_converter_window() {
  { window = new Fl_Double_Window(400, 285, getString(STR_BATCHCONVERTWINDOW_0001));
    window->user_data((void*)(this));
    { choice_file_format = new Fl_Choice(10, 19, 381, 23, getString(STR_BATCHCONVERTWINDOW_0002));
    ...
    { bt_select_src = new Fl_Button(295, 62, 95, 25, getString(STR_BATCHCONVERTWINDOW_0005));
      bt_select_src->callback((Fl_Callback*)batch_converter_window_bt_select_src);
    } // Fl_Button* bt_select_src
    { bt_select_dst = new Fl_Button(295, 130, 95, 25, getString(STR_BATCHCONVERTWINDOW_0006));
      bt_select_dst->callback((Fl_Callback*)batch_converter_window_bt_select_dst);
    } // Fl_Button* bt_select_dst
    { bt_convert = new Fl_Button(181, 198, 100, 25, getString(STR_BATCHCONVERTWINDOW_0007));
      bt_convert->callback((Fl_Callback*)batch_converter_window_bt_convert);
    } // Fl_Button* bt_convert
    { bt_cancel = new Fl_Button(290, 198, 100, 25, getString(STR_BATCHCONVERTWINDOW_0008));
      bt_cancel->callback((Fl_Callback*)batch_converter_window_bt_cancel);
    } // Fl_Button* bt_cancel
    { hlptxt = new Fl_Output(11, 193, 379, 90);
      hlptxt->box(FL_NO_BOX);
      hlptxt->align(Fl_Align(37));
      hlptxt->deactivate();
    } // Fl_Output* hlptxt
    { chkbox_rawinputsfiles = new Fl_Check_Button(9, 95, 200, 15, getString(STR_BATCHCONVERTWINDOW_0009));
    ...
    { progress_indicator = new Fl_Progress(11, 198, 165, 20);
