...
int load_last_cfg()
{
	...
	if(f)
	{
		...
		demo->autoselectmode=lastst->autoselectmode;
		demo->twistedcable=lastst->twistedcable;
	}
	else
	{
...
int save_cfg()
{
	...
	if(f)
	{
		...
		lastst->autoselectmode=demo->autoselectmode;
		lastst->twistedcable=demo->twistedcable;
