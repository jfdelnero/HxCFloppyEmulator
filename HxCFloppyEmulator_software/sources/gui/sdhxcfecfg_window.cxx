...
sdhxcfecfg_window::sdhxcfecfg_window() {
  { window = new Fl_Double_Window(565, 290, "SDCard HxC Floppy Emulator settings");
    window->labelsize(12);
    ...
    { Fl_Group* o = new Fl_Group(1, 0, 315, 289, "SD HxC Floppy Emulator Usage settings");
      ...
      { chk_disabediskdriveselector = new Fl_Check_Button(151, 131, 154, 17, "Disable drive selector");
      ...
      { chk_force_loading_startupa = new Fl_Check_Button(3, 153, 310, 16, "Force loading STARTUPA.HFE to drive A at power up");
      ...
      { chk_force_loading_startupb = new Fl_Check_Button(3, 170, 310, 16, "Force loading STARTUPB.HFE to drive B at power up");
      ...
      { Fl_Group* o = new Fl_Group(1, 233, 315, 55, "AUTO BOOT Mode / File Selector software startup");
        ...
        o->labelsize(10);
        o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
        { chk_enable_autoboot_mode = new Fl_Check_Button(3, 249, 142, 18, "Enable auto boot mode");
        ...
        { chk_force_loading_autoboot = new Fl_Check_Button(3, 268, 226, 18, "Force loading AUTOBOOT.HFE at power up");
        ...
        { chk_preindex = new Fl_Check_Button(144, 249, 171, 18, "Enable index Pre increment");
      ...
      { Fl_Group* o = new Fl_Group(1, 190, 315, 45, "Indexed Mode");
        ...
        o->labelsize(10);
        o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
        { chk_enable_indexed_mode = new Fl_Check_Button(3, 210, 132, 16, "Enable indexed mode");
    ...
    { Fl_Group* o = new Fl_Group(316, 0, 250, 234, "HFE file interfacemode");
      ...
      { Fl_Group* o = new Fl_Group(316, 97, 250, 137, "SD HxC Floppy Emulator Interface setting");
        ...
        { chk_drvb_as_motoron = new Fl_Check_Button(321, 210, 240, 16, "Drive B input as Drives Motor ON");
    ...
    { Fl_Button* o = new Fl_Button(318, 235, 107, 25, "Load config file");
      o->labelsize(12);
      o->callback((Fl_Callback*)sdhxcfecfg_window_bt_load, (void*)(this));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(318, 262, 107, 25, "Save config file");
      o->labelsize(12);
      o->callback((Fl_Callback*)sdhxcfecfg_window_bt_save, (void*)(this));
    } // Fl_Button* o
    { Fl_Button* o = new Fl_Button(473, 262, 90, 25, "OK");
      o->labelsize(12);
