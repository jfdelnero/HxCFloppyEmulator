...
batch_converter_window::batch_converter_window() {
  { window = new Fl_Double_Window(400, 285, "Floppy Disk Images Batch converter");
    window->user_data((void*)(this));
    { choice_file_format = new Fl_Choice(10, 19, 381, 23, "Target file format :");
    ...
    { chkbox_rawinputsfiles = new Fl_Check_Button(9, 95, 200, 15, "Treat input files as RAW files");
