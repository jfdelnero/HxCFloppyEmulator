...
fat12config configlist[]=
{
	...
	{"fat4572",0xFF,254 ,2,18,300,500000,win95_bootsector,84,1,IBMPC_HD_FLOPPYMODE,IBMFORMAT_DD,0xF0,4,512,224,1}, //3.5" Double Sided, 80 tracks per side, 18 sectors per track (1.44MB)
